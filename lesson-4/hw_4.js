...
const countAmount = function(lengthChoc, widthChoc) {
    // if ((lengthChoc = 1) && (widthChoc = 1)) {
    //     result = 0;
    //     console.log(result);
    // } else 
    if ((lengthChoc >= 1) && (widthChoc >= 1)) {
        lengthChoc = lengthChoc - 1;
        widthChoc = widthChoc - 1;
        result = lengthChoc + widthChoc;
        console.log(result);
    } else {
        result = 0;
        console.log(result);
...
countAmount(+prompt("Введите длину шоколадки: "), +prompt("Введите ширину шоколадки: "));
