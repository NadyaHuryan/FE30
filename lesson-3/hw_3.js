...
num2 = +prompt("Введите число с клавиатуры");
let m = +prompt("Сколько отнять?"),
    k = +prompt("Сколько прибавить?"),
    c = +prompt("Сколько умножить?"),
    d = +prompt("Сколько разделить?");
alert(`((((${num2} - ${m}) + ${k}) *${c}) / ${d} =  ${((((num2 - m) + k) * c) / d)}`);

// Task 3
num = +prompt("Введите высоту елочки с клавиатуры");
let fir = "";
for (i = 1; i<=num; i++) {    
    fir+= "#"
